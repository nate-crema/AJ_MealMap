...
// interfaces
import { ShopWorkTimeType } from "@interfaces/service/service.data.types/Shop";
import {  ShopWorkTimeDefaultServiceType } from "@constant/service/Shop";
import { WorktimeManagerModeTypes } from "@interfaces/WorktimeManager";

type WorktimeManagerProps = {
    currentDay?: number,
    workTime?: ShopWorkTimeType,
    setWorkTime?: ( workTime: ShopWorkTimeType ) => void
    mode: WorktimeManagerModeTypes
}

// components

const WorktimeManager: React.FC<WorktimeManagerProps> = ({ currentDay = new Date().getDay(), workTime, setWorkTime, mode }) => {
    ...
    return <div className="worktime-display">
        <div/>
