...
// css
import '@styles/components/ReviewEntrypoint.css';

// components

// interface
import { SubdisplayMountMode } from "@src/interfaces/Subdisplay";

type touchState = "na" | "toUp" | "toDown";



const ReviewEntrypoint: React.FC = () => {
...
export default ReviewEntrypoint