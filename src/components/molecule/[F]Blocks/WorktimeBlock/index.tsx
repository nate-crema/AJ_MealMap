...
import { WorktimeBlockModeTypes } from "./types";

type WorktimeBlockProps = {
    currentDay?: number,
    workTime?: ShopWorkTimeType,
    setWorkTime?: ( workTime: ShopWorkTimeType ) => void
    mode: WorktimeBlockModeTypes
}

// components

const WorktimeBlock: React.FC<WorktimeBlockProps> = ({ currentDay = new Date().getDay(), workTime, setWorkTime, mode }) => {
