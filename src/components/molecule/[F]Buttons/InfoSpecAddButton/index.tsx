...
import { InfoSpecificOpenInfoAddType, InfoSpecificOpenInfoDisplayType } from "@template/InfoSpecific/type";

// interfaces
type InfoSpecAddButtonProps = {
    className: string,
    type: "plus" | "edit",
...
const InfoSpecAddButton: React.FC<InfoSpecAddButtonProps> = ({ className, type, children, onClick, specinfo_type }) => {
...
export default InfoSpecAddButton