    ...
    return <>
        {
            ( qid === "QID_Restaurant_Number"
                ...
                <svg 
                    id="QID_Restaurant_Number_SVG_WAFFLE"
                    width="21.322"
                    height="21.366"
                    viewBox="0 0 21.322 21.366"
                >
                    <path 
                        id="QID_Restaurant_Number_PATH_WAFFLE"
                        data-name="QID_Restaurant_Number"
            ...
            : ( qid === "QID_Restaurant_Menu"
                ...
                <svg 
                    id="QID_Restaurant_Menu_SVG_WAFFLE"
                    width="35.982"
                    height="28.407"
                ...
                >
                    ...
                    >
                        <path 
                            id="QID_Restaurant_Menu_SVG_WAFFLE-Path_2"
                            data-name="QID_Restaurant_Menu"
            ...
            : ( qid === "QID_Restaurant_Worktime"
                ...
                <svg
                    id="QID_Restaurant_Worktime_SVG_WAFFLE"
                    width="32.564"
                    height="32.564"
                    viewBox="0 0 32.564 32.564"
                >
                    <g
                        id="QID_Restaurant_Worktime-Group_553"
                        data-name="Group 553"
                        transform="translate(-567.149 -548.145)"
                    >
                        <path
                            id="QID_Restaurant_Worktime-Path_7"
                            data-name="Path 7"
                        ...
                        />
                        <g
                            id="QID_Restaurant_Worktime-Group_552"
                            data-name="Group 552"
                        >
                            <path
                                id="QID_Restaurant_Worktime-Path_12"
                                data-name="Path 12"
