...
import DepartSelector, { SelectionValueType } from "@molecule/[F]Selector/DepartSelector";
import { DepartedUserInfo, UserDepartAPIResult } from "@interfaces/api/univ";
import { checkUserDepart as checkUserDepartAPI } from "@api/univ";
