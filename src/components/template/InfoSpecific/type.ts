...
type OPENINFO_CLOSED_TMP = "CLOSED_TMP";
...
export type InfoSpecificOpenInfoDisplayType = OPENINFO_CLOSED | OPENINFO_LOCATION | OPENINFO_MENU | OPENINFO_WORKTIME | OPENINFO_CONTACT | OPENINFO_IMAGE | OPENINFO_REVIEW | OPENINFO_EVENT | OPENINFO_CLOSED_TMP;
export type InfoSpecificOpenInfoAddType = OPENINFO_ADD_LOCATION | OPENINFO_ADD_MENU | OPENINFO_ADD_WORKTIME | OPENINFO_ADD_CONTACT | OPENINFO_ADD_IMAGE | OPENINFO_ADD_REVIEW | OPENINFO_ADD_EVENT ;

export type InfoSpecificOpenInfoType =
    InfoSpecificOpenInfoDisplayType |
    InfoSpecificOpenInfoAddType
;
