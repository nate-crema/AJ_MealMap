    ...
    function _designHandler(e) {
        ...
        if (isMobile()) {
            ...
            if (window.location.pathname == "/") {
                ...
                updateCss.logo_loc.left = "150px";
                
            } else {
                // logo position change
                updateCss.logo_loc.left = "50px";
            }
        }
            ...
            >
                <Router key={pagekey}>
                    <div className="logoArea" style={{ ...css.logo_loc }} >
                        <Logo className="logoComp" onClick={() => window.location.href = "/"}></Logo>
                        <div className="ctrlArea" ref={ctrl_ref}></div>
                    </div>
                    {/* <TransitionGroup className="routeTransition">
                        <CSSTransition 
                            classNames="routeTrans_fade" 
                            key={pagekey} 
